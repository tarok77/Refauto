...
@Component
public class Book {
    private com.tarok.citationgenerator.repository.valueobjects.Title title;

    private Authors authors;

    private PublishedYear publishedYear;

    private com.tarok.citationgenerator.repository.valueobjects.Publisher publisher;
    ...
    public static Book of(String title, String creators, String publishedYear, String publisher, String isbn) {
        ...
        book.title = com.tarok.citationgenerator.repository.valueobjects.Title.nameOf(title);
        book.setCreators(creatorPair);
        book.publishedYear = PublishedYear.of(publishedYear);
        book.publisher = com.tarok.citationgenerator.repository.valueobjects.Publisher.nameOf(publisher);
    ...
    public static Book format(RawBook raw) {
        ...
        book.setTitle(com.tarok.citationgenerator.repository.valueobjects.Title.nameOf(raw.getOptionalTitle().orElse("NO_DATA")));
        book.setCreators(creatorsConverter.convertRawBook(raw));
        book.setPublisher(new com.tarok.citationgenerator.repository.valueobjects.Publisher(raw.getOptionalPublisher().orElse("NO_DATA")));
    ...
    public static Book fromBookForView(BookForView bookForView) {
        ...
        book.setTitle(com.tarok.citationgenerator.repository.valueobjects.Title.nameOf(Objects.requireNonNullElse(bookForView.getTitle(),("NO_DATA"))));
        ...
        book.setPublisher(com.tarok.citationgenerator.repository.valueobjects.Publisher.nameOf(Objects.requireNonNullElse(bookForView.getPublisher(),("NO_DATA"))));
