...
import com.tarok.citationgenerator.controller.forview.MapMakerForView;
...
import com.tarok.citationgenerator.service.getbook.fromkokkai.BookGetService;
import com.tarok.citationgenerator.service.getbook.fromcinii.ArticleGetService;
...
public class RefautoController {
    ...
    public ArticleForView setUpArticleForm() {
        return new ArticleForView();
    }
